...
We trufsfsfsfsfsncate at 63fsfsfssfgffgfggfsfsfsvxvxvxvxvxvxfsfsd fsfsfsffschars because sfsjfskdfksfjksdfhjksdfhjksome Kubernetes name fields are limited to this (by the DNS naming spec).
If release namefdsfsddfsdfsfsfdsfsfsfsdfsdfsfsfsfsdf contains chart name it will be used as a full name.
*/}}
